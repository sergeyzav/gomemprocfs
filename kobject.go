...
// GetKObjectList retrieves the Windows kernel object manager directory tree.
// Each entry includes the object's virtual address, parent, children, name, and type.
